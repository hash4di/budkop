...
describe 'welcome/index.html.haml' do
  ...
  it 'should have facebook_link' do
    rendered.should have_selector('div#facebook_link', :href => 'http://facebook.com/budkop', :content => 'http://facebook.com/budkop')
  end

  it 'should have Twitter_link' do
    rendered.should have_selector('div#twitter_follow', :href => 'http://twitter.com/budkop', :content => 'follow us on twitter')
  end
